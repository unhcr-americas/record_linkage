...
Revise the[demo script](FastLink.html) and  [ applied real use case script](https://github.com/unhcr-americas/record_linkage/blob/main/deduplicate.R)  to use the functions
